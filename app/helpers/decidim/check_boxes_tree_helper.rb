...
module Decidim
  ...
  module CheckBoxesTreeHelper
    ...
    def scope_children_to_tree(scope)
      ...
      sorted_children_for(scope).flat_map do |child|
        TreeNode.new(
    ...
    def sorted_children_for(scope)
      scope.children.includes(:scope_type, :children).sort_by do |subscope|
        translated_attribute(subscope.name)
      end
    end
  end
end
