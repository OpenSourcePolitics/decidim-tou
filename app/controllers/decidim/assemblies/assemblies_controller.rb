  ...
  module Assemblies
    ...
    class AssembliesController < Decidim::Assemblies::ApplicationController
      ...
      def assembly_participatory_processes
        ...
        # sorted_by_category = assembly_participatory_processes.active_spaces.order(end_date: :asc)
        # sorted_by_category += assembly_participatory_processes.future_spaces.order(start_date: :asc)
        # sorted_by_category += assembly_participatory_processes.past_spaces.order(end_date: :desc)
        sorted_by_category = {
        ...
        @assembly_participatory_processes ||= sorted_by_category
      end
