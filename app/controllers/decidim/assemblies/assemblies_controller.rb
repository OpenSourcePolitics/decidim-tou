  ...
  module Assemblies
    ...
    class AssembliesController < Decidim::Assemblies::ApplicationController
      ...
      def assembly_participatory_processes
        @assembly_participatory_processes ||= @current_participatory_space.linked_participatory_space_resources(:participatory_processes, "included_participatory_processes", end_date: :desc, start_date: :asc)
      end
