  ...
  describe UserInterestScopeForm do
    ...
    describe "#map_model" do
      ...
      context "when children are provided" do
        let!(:subscope_1) { create(:subscope, name: { en: "1.2 A Scope", fr: "1.1 A Scope" }, parent: top_level_scope) }
        let!(:subscope_2) { create(:subscope, name: { en: "1.1 A Scope", fr: "1.2 A Scope" }, parent: top_level_scope) }
        let!(:subscope_3) { create(:subscope, name: { en: "1.4 A Scope", fr: "1.3 A Scope" }, parent: top_level_scope) }
        let!(:subscope_4) { create(:subscope, name: { en: "1.3 A Scope", fr: "1.4 A Scope" }, parent: top_level_scope) }
        ...
        context "when grand children are provided" do
          let!(:child_subscope_1) { create(:subscope, name: { en: "1.2.1 A Scope", fr: "1.2.1 A Scope" }, parent: subscope_1) }
          let!(:child_subscope_2) { create(:subscope, name: { en: "1.2.2 A Scope", fr: "1.2.2 A Scope" }, parent: subscope_1) }
          let!(:child_subscope_3) { create(:subscope, name: { en: "1.4.1 A Scope", fr: "1.3.1 A Scope" }, parent: subscope_2) }
          let!(:child_subscope_4) { create(:subscope, name: { en: "1.3.1 A Scope", fr: "1.4.1 A Scope" }, parent: subscope_2) }
